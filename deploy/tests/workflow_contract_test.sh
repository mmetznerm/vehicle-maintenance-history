...
assert_contains "$aws_deployment_runbook" "entrega/início de 60 segundos"
assert_contains "$aws_deployment_runbook" "execução remota de 1200 segundos"
assert_contains "$aws_deployment_runbook" "margem de polling"
assert_contains "$aws_deployment_runbook" "de 30 segundos"
assert_contains "$aws_deployment_runbook" "21 minutos e 30 segundos"
